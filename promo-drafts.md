# GamingDiver Launch — Promo Post Drafts

---

## 1. Reddit: r/WoWs_Legends

**Title:** I built a free tool to visualize your WoWS Legends stats — GamingDiver
...
## 2. Reddit: r/WoWs_Legends (shorter follow-up/crosspost version)

**Title:** Free stat analyzer for WoWS Legends — upload your data export, get detailed ship-by-ship breakdowns

**Body:**

Made a tool called GamingDiver that analyzes your Wargaming data export. Completely free, runs in your browser, no sign-up needed.
...
## 3. WoWS Legends Official Discord

**Post for #community-content or equivalent channel:**

🤿 **GamingDiver** — Free WoWS Legends stat analyzer

Just launched a free tool to visualize your Legends career stats. Request your data export from wargaming.net, drop the zip file, and instantly see:
...
Would love feedback from the community! What stats matter most to you?

---

## 4. WoWS Legends Forum Post

**Title:** [TOOL] GamingDiver — Free Visual Stat Analyzer for Legends

**Body:**

Hi everyone,

I wanted to share a tool I built for the Legends community: **GamingDiver** (gamingdiver.com).

**What is it?**
Upload your Wargaming personal data export and get a full visual breakdown of your career stats, ship performance, trends, and collection — all processed in your browser with zero data sent anywhere.

**Why I built it:**
As a Legends player, I wanted to dig deeper into my stats than the in-game tools allow. Which ships am I actually best in? How has my accuracy changed over time? Am I improving at ranked? GamingDiver answers these questions.

**Key features:**
- Career overview with stats per game mode
- Ship performance table — sortable by any stat, filterable by nation/tier/class
...
2. Download the zip when you get the email
3. Go to gamingdiver.com and drop the file
4. Explore your data!

Feedback and feature requests welcome. What would you add?
...
#WoWSLegends #WorldOfWarships #Gaming
